...
import com.app.mobile.adapters.StaffAdapter
import com.app.mobile.databinding.FragmentStaffBinding
import com.app.mobile.models.CreateStaffRequest
...
class StaffFragment : Fragment() {
    ...
    private fun showStaffDialog(staff: Staff?) {
        ...
        val etCustomRate = view.findViewById<EditText>(R.id.etCustomRate)
